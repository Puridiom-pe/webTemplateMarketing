     ...
     (function($) {
         $.fn.html5lightbox = function(options) {
             ...
             inst.showWeb = function(elem) {
                 ...
                 inst.resizeLightbox(dataW, dataH, true, function() {
                     ...
                     inst.$image.css({
                         width: sizeObj.w,
                         height: sizeObj.h
                     }).html("<div id='html5lightbox-web' style='display:block;width:100%;height:100%;-webkit-overflow-scrolling:touch;overflow-y:scroll;'></div>").show();
             ...
             inst.resizeWindow = function() {
                 ...
                 var winH = window.innerHeight ? window.innerHeight : $(window).height();
                 var elemW =
                     inst.currentElem[ELEM_WIDTH] ? inst.currentElem[ELEM_WIDTH] : winWidth;
                 var elemH = inst.currentElem[ELEM_HEIGHT] ? inst.currentElem[ELEM_HEIGHT] : winH - inst.options.navheight;
                 var keepratio = inst.currentElem[ELEM_TYPE] == 7 || inst.currentElem[ELEM_TYPE] == 8 ? false : true;
                 var sizeObj = inst.calcElemSize({
                     w: elemW,
                     h: elemH
                 }, keepratio);
                 ...
                 var boxT = Math.round((winH - inst.options.navheight) /
                     2 - boxH / 2);
                 if (inst.options.titlestyle != "inside") boxT -= Math.round(inst.options.barheight / 2);
                 if (boxT < 16) boxT = 16;
                 inst.$lightboxBox.css({
             ...
             inst.showData = function() {
                 ...
                 if (inst.$text.text().length >
                     0 && inst.options.titlestyle != "inside") inst.$lightboxBox.css({
